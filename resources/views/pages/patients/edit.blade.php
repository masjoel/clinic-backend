                ...
                <div class="card">
                    <form action="{{ route('patients.update', $patient) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error('kk') is-invalid @enderror"
                                                    name="kk" value="{{ old('kk', $patient->kk) }}">
                                                @error('kk')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="custom-switch mt-0">
                                            <input type="checkbox" id="is_deceased" class="custom-switch-input"
                                                {{ $patient->is_deceased == 1 ? 'checked' : '' }}>
                                            <span class="custom-switch-indicator"></span>
                                        </label>
                                        <input type="hidden" name="is_deceased" value="{{ $patient->is_deceased }}">
                                    </div>
                                    <div class="form-group mb-2">
                                        <label>Alamat lengkap</label>
                                        <textarea data-height="50" class="form-control @error('address_line') is-invalid @enderror" name="address_line">{{ old('address_line', $patient->address_line) }}</textarea>
                                        @error('address_line')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control @error('rt') is-invalid @enderror"
                                                    name="rt" value="{{ old('rt', $patient->rt) }}">
                                                @error('rt')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <select class="form-control select2  @error('province_code') is-invalid @enderror"
                                            ...
                                            @foreach ($provinsi as $item)
                                                <option value="{{ $item->code . '-' . $item->name }}"
                                                    {{ $patient->province_code == $item->code ? 'selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2  @error('city_code') is-invalid @enderror"
                                            ...
                                            @foreach ($kabupaten as $item)
                                                <option value="{{ $item->code . '-' . $item->name }}"
                                                    {{ $patient->city_code == $item->code ? 'selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2  @error('district_code') is-invalid @enderror"
                                            ...
                                            @foreach ($kecamatan as $item)
                                                <option value="{{ $item->code . '-' . $item->name }}"
                                                    {{ $patient->district_code == $item->code ? 'selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2  @error('village_code') is-invalid @enderror"
                                            ...
                                            @foreach ($kelurahan as $item)
                                                <option value="{{ $item->code . '-' . $item->name }}"
                                                    {{ $patient->village_code == $item->code ? 'selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('relationship_name', $patient->relationship_name) }}"
                                            autocomplete="off">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('relationship_phone', $patient->relationship_phone) }}"
                                            autocomplete="off">
                        ...
                        <div class="card-footer text-right">
                            <input type="hidden" name="province_code" value="{{ $patient->province_code }}">
                            <input type="hidden" name="city_code" value="{{ $patient->city_code }}">
                            <input type="hidden" name="district_code" value="{{ $patient->district_code }}">
                            <input type="hidden" name="village_code" value="{{ $patient->village_code }}">
                            <input type="hidden" name="province" value="{{ $patient->province }}">
                            <input type="hidden" name="city" value="{{ $patient->city }}">
                            <input type="hidden" name="district" value="{{ $patient->district }}">
                            <input type="hidden" name="village" value="{{ $patient->village }}">
